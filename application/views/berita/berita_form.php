...
$(document).ready(function() {
    ...
    $('#btn-filter').click(function(){ //button filter event click
        reload_berita_table();  //just reload table
    });
    ...
    $.ajax({
        ...
        success: function(data)
        {
			...
			if(data.photo)
            {
                ...
                $('#photo-preview div').html('<img src="'+base_url+'upload/berita/thumbs/'+data.photo+'" class="img-responsive">'); // show photo
    ...
    if(list_id.length > 0)
    {
        if(confirm('Are you sure delete this '+list_id.length+' data?'))
        {
            $.ajax({
                type: "POST",
                data: {id:list_id},
                url: "<?php echo site_url('berita/ajax_bulk_delete')?>",
                dataType: "JSON",
                success: function(data)
                {
                    if(data.status)
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
				...
				<div class="form-group">
					<label class="control-label col-md-3" for="judul_berita">Judul Berita</label>
					<div class="col-md-9">
    				<input placeholder="Judul Berita" type="text" name="judul_berita" class="form-control" />		
					<span class="help-block"></span>
					</div>
				</div>
				
				<div class="form-group">
					<label class="control-label col-md-3" for="isi_berita">Isi Berita</label>
					<div class="col-md-9">
					<textarea class="form-control" name="isi_berita" id="isi_berita"><?php echo set_value('isi_berita', isset($default['isi_berita']) ? $default['isi_berita'] : ''); ?></textarea>
					<span class="help-block"></span>
					</div>
				</div>
